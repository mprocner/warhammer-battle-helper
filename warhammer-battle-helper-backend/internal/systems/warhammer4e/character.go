...
// Stats holds all Warhammer Fantasy Roleplay 4e character data.
...
type WoundsInfo struct {
	SB      int  `bson:"sb" json:"sb"`
	TB      int  `bson:"tb" json:"tb"`
	WPB     int  `bson:"wpb" json:"wpb"`
	Hardy   int  `bson:"hardy" json:"hardy"`
	Total   int  `bson:"total" json:"total"`
...
type ArmourPoints struct {
	Head     int `bson:"head" json:"head"`
	LeftArm  int `bson:"leftArm" json:"leftArm"`
	RightArm int `bson:"rightArm" json:"rightArm"`
	Body     int `bson:"body" json:"body"`
	LeftLeg  int `bson:"leftLeg" json:"leftLeg"`
	RightLeg int `bson:"rightLeg" json:"rightLeg"`
	Shield   int `bson:"shield" json:"shield"`
}
